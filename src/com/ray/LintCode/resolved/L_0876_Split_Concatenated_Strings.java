 ...
 * where for each string you could choose to reverse it or not. Among all the possible loops, you need to find the
 *  lexicographically biggest string after cutting the loop, which will make the looped string into a regular one.
 *
 ...
 *       
 *    2. Cut and make one breakpoint in any place of the loop, which will make the looped string
 *       into a regular one starting from the character at the cutpoint.
 * 
 * And your job is to find the lexicographically biggest one among all the possible regular strings.
 * 
 * Note that the string concatenation order and the direction of the loop are all left to right 
 * (i.e. the direction in which the index increases).
 *
 * @author rays1
 * @url    https://www.lintcode.com/problem/split-concatenated-strings/description
 */
public class L_0876_Split_Concatenated_Strings {
    ...
    public static void main(String[] args) {
        ...
        Out.p(new Solution().splitLoopedString(strs));
