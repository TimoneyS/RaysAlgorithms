 ...
 *   Also, if you step on the index i, you have to pay Ai coins. If Ai is -1, 
...
Now, you start from the place indexed 1 in the array A, and your aim is to reach the place indexed N using
 the minimum coins. You need to return the path of indexes (starting from 1 to N) in the array you 
...
public class L_0866_Coin_Path {
    ...
    public static void main(String[] args) {
        ...
        Out.p(new Solution().cheapestJump(A, B));
